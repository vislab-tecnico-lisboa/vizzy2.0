...
class RecoverySupervisor(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter('good_covariance', 0.04)           # pos var x+y: recovered/store-good below this
        self.declare_parameter('good_yaw_covariance', 0.0)        # yaw var: <=0 disables the yaw term
        self.declare_parameter('diverged_covariance', 0.08)       # pos var x+y: divergence above this
